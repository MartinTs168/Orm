...
class VengeanceDemonHunter(DemonHunter):
    ...
    retribution_ability = models.CharField(max_length=1000)
...
class Message(models.Model):
    ...
    def mark_as_read(self):
        self.is_read = True
        # we don't save in case for judge
...
class StudentIDField(models.PositiveIntegerField):
    ...
    def get_prep_value(self, value):
        ...
        if cleaned_value <= 0:
            raise ValidationError("ID cannot be less or equal to zero")
...
class BaseReservation(models.Model):
    ...
    def calculate_total_cost(self):
        price = self.room.price_per_night * self.reservation_period()
