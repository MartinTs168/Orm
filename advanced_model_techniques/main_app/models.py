...
class Restaurant(models.Model):
    name = models.CharField(
        max_length=100,  # this works on database level and sets the max length of the name column
        validators=[
            MinLengthValidator(2, message="Name must be at least 2 characters long."),  # works on django level
